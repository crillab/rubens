 ...
 */
@TestGeneratorFactoryParams(name="ARG-STG")
public class StageSemTestGeneratorFactory implements TestGeneratorFactory<ArgumentationFramework> {
	...
	public List<InstanceTranslator<ArgumentationFramework>> translators() {
		return Stream.of(new NewArgTranslator(), new NewAttackTranslator(EExtensionSetComputer.STAGE_SEM)).collect(Collectors.toList());
	}
