 ...
 */
@ReflectorParam(name="ARG-CO", family="AF")
public class CompleteSemTestGeneratorFactory extends ASemTestGeneratorFactory {
	 ...
	 */
	public CompleteSemTestGeneratorFactory() {
		this(true);
	}
	 ...
	 */
	public CompleteSemTestGeneratorFactory(final boolean emptyInstanceAllowed) {
		super(EExtensionSetComputer.COMPLETE_SEM, emptyInstanceAllowed);
	}
