 ...
 */
@TestGeneratorFactoryParams(name="ARG-SST")
public class SemistableSemTestGeneratorFactory implements TestGeneratorFactory<ArgumentationFramework> {
	...
	public List<InstanceTranslator<ArgumentationFramework>> translators() {
		return Stream.of(new NewArgTranslator(), new NewAttackTranslator(EExtensionSetComputer.SEMISTABLE_SEM)).collect(Collectors.toList());
	}
