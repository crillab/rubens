 ...
 */
@TestGeneratorFactoryParams(name="ARG-GR")
public class GroundedSemTestGeneratorFactory implements TestGeneratorFactory<ArgumentationFramework> {
	...
	public List<InstanceTranslator<ArgumentationFramework>> translators() {
		return Stream.of(new NewArgTranslator(), new NewAttackTranslator(EExtensionSetComputer.GROUNDED_SEM)).collect(Collectors.toList());
	}
